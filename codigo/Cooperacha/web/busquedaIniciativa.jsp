         ...
         <div class="text-center container">
          ...
          <div class="form-group">
              ...
              <table class="table table-striped table-bordered table-condensed">
                  		<tr>
                                    <td>cod_iniciativa</td><td>nombre</td><td>descripcion</td><td>tiempo</td><td>cod_categoria</td><td>cod_usuario</td><td>estado</td><td>meta</td><td>monto</td><td>mostrar</td>
                  		</tr>
              ...
              %><tr>
                  <td><%=cod_iniciativa%></td><td><%=nombre%></td><td><%=descripcion%></td><td><%=tiempo%></td><td><%=cod_categoria%></td><td><%=cod_usuario%></td><td>activado</td><td><%=meta%></td><td><%=monto%></td><td><button class="form-control btn btn-primary" type="submit" value="<%=cod_iniciativa%>" name="<%=cod_iniciativa%>">ver</button></td>
               </tr><%
