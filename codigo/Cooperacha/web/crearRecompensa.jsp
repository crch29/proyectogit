<%-- 
    Document   : crearRecompensa
    Created on : 29/06/2016, 03:57:03 AM
    Author     : carlosrene
--%>
         ...
         <div class="text-center container">
          ...
          <div class="form-group">
              ...
              %><tr>
                  ...
                  <td><%=nombre%></td><td><%=descripcion%></td><td><%=meta%></td><td><%=tiempo%><td><%=monto%></td><td><button class="form-control btn btn-primary" type="submit" value="<%=cod_iniciativa%>" name="<%=cod_iniciativa%>">crear recompensa</button></td>
               </tr><%
                        ...
                        if(clave!=null){
                            ...
                            %><jsp:forward page="ingresarRecompensa.jsp"></jsp:forward><%
                        }
