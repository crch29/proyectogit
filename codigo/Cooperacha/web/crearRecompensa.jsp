<%-- 
    ...
    Created on : 27/06/2016, 09:52:45 AM
    Author     : carlosrene
--%>
         ...
         <div class="text-center container">
          ...
          <div class="form-group">
              ...
              %><tr>
                  ...
                  <td><%=nombre%></td><td><%=meta%></td><td><%=monto%></td><td><button class="form-control btn btn-primary" type="submit" value="<%=cod_iniciativa%>" name="<%=cod_iniciativa%>">crear recompensa</button></td>
               </tr><%
