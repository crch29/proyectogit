<%-- 
    Document   : denunciarComentario
    Created on : 9/07/2016, 08:27:28 AM
    Author     : carlosrene
--%>
        ...
        <div id="navbarCollapse" class="collapse navbar-collapse">
         ...
         <div class="text-center container">
          ...
          <div class="form-group">
              ...
              %><tr>
                  <td><%=cod_iniciativa%></td><td><%=nombre%></td><td><%=descripcion%></td><td><%=tiempo%></td><td><%=cod_categoria%></td><td><%=cod_usuario%></td><td>activado</td><td><%=meta%></td><td><%=monto%></td><td><button class="form-control btn btn-primary" type="submit" value="<%=cod_iniciativa%>" name="<%=cod_iniciativa%>">ver comentarios</button></td>
               </tr><%
                        ...
                        if(clave!=null){
                            ...
                            %><jsp:forward page="denunciarComentarioII.jsp"></jsp:forward><%
                        }
                        }
                    } catch (Exception ex) {
