<%-- 
    ...
    Created on : 12/07/2016, 12:04:46 AM
    Author     : carlosrene
--%>
    ...
    <head>
       ...
       <body background="startup-1.jpg">
        ...
        <div id="navbarCollapse" class="collapse navbar-collapse">
           ...
           <form name="iniciativa" role="form" action="eliminarUsuario.jsp">
         <div class="text-center container">
          ...
          <div class="form-group">
              ...
              %><tr>
                  ...
                  <td><%=codigo%></td><td><%=nickname%></td><td><%=nombre%></td><td><button class="form-control btn btn-primary" type="submit" value="<%=codigo%>" name="<%=codigo%>">Borrar</button></td>
               </tr><%
                        String clave=request.getParameter(String.valueOf(codigo));
                        if(clave!=null){
                           port.eliminarUsuario(clave);
                        }
                        }
                    }catch (Exception ex) {
