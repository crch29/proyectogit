<%-- 
    Document   : modificarIniciativaI
    Created on : 27/06/2016, 12:39:28 PM
    Author     : carlosrene
--%>
         ...
         <div class="text-center container">
          ...
          <div class="form-group">
              ...
              %><tr>
                  ...
                  <td><%=nombre%></td><td><%=meta%></td><td><%=monto%></td><td><button class="form-control btn btn-primary" type="submit" value="<%=cod_iniciativa%>" name="<%=cod_iniciativa%>">Modificar</button></td>
               </tr><%
                        ...
                        if(clave!=null){
                            ...
                            %><jsp:forward page="modificarIniciativa.jsp"></jsp:forward><%
                        }
