<%-- 
    Document   : topiniciativasporusuarios
    Created on : 9/07/2016, 04:46:27 AM
    Author     : carlosrene
--%>
...
<%
            ...
            File reporte= new File(application.getRealPath("//reportes//topiniciativasporusuario.jasper"));
